...
class TemplateManager:
    ...
    def edit_template(self, template_name: str) -> None:
        ...
        if not template_path:
            console.print(f"[red]Cannot find template file for '{template_name}'.[/red]")
            return
        ...
        if '.ccdebug' not in str(template_path):
            ...
            console.print(f"[yellow]Copied built-in template to user directory for editing.[/yellow]")
    ...
    def test_template(self, template_name: str, 
                     sample_file: Optional[Path] = None) -> None:
    ...
    def share_template(self, template_name: str) -> None:
        ...
        metadata = {
            ...
            'version': self.template_system.templates[template_name].get('version', '1.0.0'),
            'description': self.template_system.templates[template_name].get('description', ''),
        }
