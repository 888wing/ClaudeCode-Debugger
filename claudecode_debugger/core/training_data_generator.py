...
class TrainingDataGenerator:
        ...
        return {
            ErrorCategory.TYPESCRIPT.value: [
                ...
                },
                {
                    ...
                    'severity': 'high',
                    'variations': {
                        'module': ['react', '@types/node', './config', '../utils/helpers']
                    }
                }
            ],
            ...
            ErrorCategory.JAVASCRIPT.value: [
                {
                    ...
                    'variations': {
                        ...
                        'function': ['Array.map', 'Object.keys', 'handleClick', 'render'],
            ...
            ErrorCategory.PYTHON.value: [
                {
                    ...
                    'variations': {
                        ...
                        'error_type': ['KeyError', 'ImportError', 'ZeroDivisionError', 'IndexError'],
                        'message': ["'key'", "No module named 'missing_module'", "division by zero", "list index out of range"]
                    }
                },
                {
                    ...
                    'severity': 'medium',
                    'variations': {
                        'message': ["Operation timed out after 30.0 seconds", "Future didn't complete within 60 seconds"]
                    }
                }
            ],
            ...
            ErrorCategory.MEMORY.value: [
                ...
                },
                {
                    ...
                    'severity': 'critical',
                    'variations': {
                        'space': ["Java heap space", "GC overhead limit exceeded", "Metaspace"]
                    }
                }
            ],
            ...
            ErrorCategory.NETWORK.value: [
                {
                    ...
                    'severity': 'medium',
                    'variations': {
                        'url': ['https://api.example.com/data', 'http://localhost:3001/api/users'],
            ...
            ErrorCategory.DATABASE.value: [
                {
                    ...
                    'severity': 'high',
                    'variations': {
                        'db_error': ['psycopg2.errors.UndefinedTable', 'mysql.connector.errors.ProgrammingError', 'sqlite3.OperationalError'],
                        'message': [
    ...
    def generate_examples(self, count: int = 1000, 
    ...
    def _add_noise(self, text: str) -> str:
        ...
        noise_types = [
            lambda t: f"[2023-10-{random.randint(1,30):02d} {random.randint(0,23):02d}:{random.randint(0,59):02d}:{random.randint(0,59):02d}] " + t,
            lambda t: f"ERROR: " + t,
...
[28729:0x102801000]    30065 ms: Mark-sweep 1387.0 (1420.0) -> 1386.9 (1421.0) MB, 184.9 / 0.0 ms  (average mu = 0.112, current mu = 0.011) allocation failure scavenge might not succeed
[28729:0x102801000]    30253 ms: Mark-sweep 1387.9 (1421.0) -> 1387.8 (1421.5) MB, 187.3 / 0.0 ms  (average mu = 0.060, current mu = 0.003) allocation failure scavenge might not succeed
...
Security context: 0x38e8c7b9e6e1 <JSObject>
    1: _send [internal/child_process.js:~778] [pc=0x3d2f828bfc55](this=0x38e84885cf51 <ChildProcess map = 0x38e814896361>,message=0x38e848864ae1 <Object map = 0x38e8148a1fe1>,handle=0x38e8ba8026f1 <undefined>,options=0x38e848864b41 <Object map = 0x38e814882f11>,callback=0x38e8ba8026f1 <undefined>)
...
##[error]Docker build failed with exit code 1""",
            categories=[ErrorCategory.DOCKER.value, ErrorCategory.BUILD.value, ErrorCategory.CICD.value],
            severity='high'
        ))
        
        return examples
    
    def export_training_data(self, examples: List[TrainingExample], 
