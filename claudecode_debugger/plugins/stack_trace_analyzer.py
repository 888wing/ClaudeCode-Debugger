...
class StackTraceAnalyzer(Plugin):
    ...
    def analyze(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if frames:
            ...
            results["external_dependencies"] = self._find_external_deps(
                frames, patterns
            )
    ...
    def _extract_error_info(
        ...
        for line in reversed(lines[-10:]):  # Check last 10 lines
            ...
            if match:
                ...
                error_message = (
                    match.group(2) if match.lastindex >= 2 else match.group(3)
                )
    ...
    def _find_external_deps(
        self, frames: List[Dict[str, Any]], patterns: Dict[str, str]
    ) -> List[str]:
