...
class TestPromptGenerator:
    ...
    def test_custom_agent_selection(self, generator):
        ...
        prompt = generator.generate(
            "Some error", "general", custom_agent="frontend-system-builder"
        )
    ...
    def test_template_context_preparation(self, generator):
        ...
        context = generator._prepare_context("Test error", "javascript", error_info)
    ...
    def test_template_fallback(self, generator):
        ...
        prompt = generator.generate("Unknown error type", "nonexistent_type")
